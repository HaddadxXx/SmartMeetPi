...
public class SponsoringOfferService {
    ...
    public SponsoringOfferService(RestTemplate restTemplate) {
    ...
    public Map<String, Long> getOfferStatistics() {
        List<SponsoringOffer> offers = sponsoringOfferRepository.findAll();
        long sponsoredCount = offers.stream().filter(o -> o.getContractId() != null && !o.getContractId().isEmpty()).count();
        long nonSponsoredCount = offers.stream().filter(o -> o.getContractId() == null || o.getContractId().isEmpty()).count();

        Map<String, Long> stats = new HashMap<>();
        stats.put("sponsored", sponsoredCount);
        stats.put("nonSponsored", nonSponsoredCount);
