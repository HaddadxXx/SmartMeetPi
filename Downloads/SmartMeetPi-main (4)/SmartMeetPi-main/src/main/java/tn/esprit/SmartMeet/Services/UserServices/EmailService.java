...
public class EmailService {
    ...
    public void sendContractExpirationAlert(String toEmail, String contractTitle, Date expirationDate) {
        SimpleMailMessage message = new SimpleMailMessage();
        message.setFrom("khalilhdd8@gmail.com");

        message.setTo(toEmail);
        message.setSubject("⚠️ Alerte : Expiration de contrat imminente");
        message.setText("Le contrat \"" + contractTitle + "\" va expirer le " + expirationDate + ". Veuillez agir rapidement !");
        mailSender.send(message);
    }
}
